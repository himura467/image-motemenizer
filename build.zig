...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("image_motemenizer", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "image_motemenizer" is the name you will use in your source code to
                // import this module (e.g. `@import("image_motemenizer")`). The name is
